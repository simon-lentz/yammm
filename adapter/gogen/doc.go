...
// For the narrow cases it cannot faithfully render in Go — a schema with no
// retained source, a name clash schema-qualification cannot resolve, or an
// association whose target type has no primary key — it returns an error rather
// than emitting broken or misleading Go.
//
