...
// normalization contract (NormalizeLineEndings in internal/docstate/normalize.go).
...
// logic in AnalyzeMarkdownAndPublish (internal/workspace/markdown.go) must be updated together.
