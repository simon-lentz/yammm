...
func TestNewProperty(t *testing.T) {
	...
	p := schema.TestNewProperty("name", span, doc, constraint, schema.DataTypeRef{}, false, false, scope, nil)
...
func TestProperty_Accessors(t *testing.T) {
	...
	p := schema.TestNewProperty("quantity", span, "Item count", constraint, schema.DataTypeRef{}, true, true, scope, nil)
...
func TestProperty_IsOptional(t *testing.T) {
	optionalProp := schema.TestNewProperty("opt", location.Span{}, "", nil, schema.DataTypeRef{}, true, false, schema.DeclaringScope{}, nil)
	requiredProp := schema.TestNewProperty("req", location.Span{}, "", nil, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
...
func TestProperty_IsPrimaryKey(t *testing.T) {
	pkProp := schema.TestNewProperty("id", location.Span{}, "", nil, schema.DataTypeRef{}, false, true, schema.DeclaringScope{}, nil)
	normalProp := schema.TestNewProperty("name", location.Span{}, "", nil, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
...
func TestProperty_Equal_Identical(t *testing.T) {
	constraint := schema.NewStringConstraint()
	p1 := schema.TestNewProperty("name", location.Span{}, "", constraint, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
	p2 := schema.TestNewProperty("name", location.Span{}, "", constraint, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
...
func TestProperty_Equal_DifferentName(t *testing.T) {
	constraint := schema.NewStringConstraint()
	p1 := schema.TestNewProperty("name", location.Span{}, "", constraint, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
	p2 := schema.TestNewProperty("title", location.Span{}, "", constraint, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
...
func TestProperty_Equal_DifferentOptional(t *testing.T) {
	constraint := schema.NewStringConstraint()
	p1 := schema.TestNewProperty("name", location.Span{}, "", constraint, schema.DataTypeRef{}, true, false, schema.DeclaringScope{}, nil)
	p2 := schema.TestNewProperty("name", location.Span{}, "", constraint, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
...
func TestProperty_Equal_DifferentPrimaryKey(t *testing.T) {
	constraint := schema.NewStringConstraint()
	p1 := schema.TestNewProperty("id", location.Span{}, "", constraint, schema.DataTypeRef{}, false, true, schema.DeclaringScope{}, nil)
	p2 := schema.TestNewProperty("id", location.Span{}, "", constraint, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)

	assert.False(t, p1.Equal(p2))
}

func TestProperty_Equal_DifferentConstraint(t *testing.T) {
	p1 := schema.TestNewProperty("value", location.Span{}, "", schema.NewStringConstraint(), schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
	p2 := schema.TestNewProperty("value", location.Span{}, "", schema.NewIntegerConstraint(), schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)

	assert.False(t, p1.Equal(p2))
}

func TestProperty_Equal_NilConstraints(t *testing.T) {
	p1 := schema.TestNewProperty("value", location.Span{}, "", nil, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
	p2 := schema.TestNewProperty("value", location.Span{}, "", nil, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
...
func TestProperty_Equal_OneNilConstraint(t *testing.T) {
	p1 := schema.TestNewProperty("value", location.Span{}, "", nil, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
	p2 := schema.TestNewProperty("value", location.Span{}, "", schema.NewStringConstraint(), schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
...
func TestProperty_Equal_IgnoresSpanAndDoc(t *testing.T) {
	...
	p1 := schema.TestNewProperty("name", span1, "Doc 1", constraint, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
	p2 := schema.TestNewProperty("name", span2, "Doc 2", constraint, schema.DataTypeRef{}, false, false, schema.DeclaringScope{}, nil)
...
func narrowProp(name string, constraint schema.Constraint, optional, pk bool) *schema.Property {
	return schema.TestNewProperty(name, location.Span{}, "", constraint, schema.DataTypeRef{}, optional, pk, schema.DeclaringScope{}, nil)
}
